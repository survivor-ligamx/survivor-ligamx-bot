...
La respuesta incluye `estados_dp_evaluados` para vigilar la complejidad de la programación dinámica. Las transiciones con vida disponible y consumida tienen cobertura de regresión.
